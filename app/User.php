 ...
 * @property string|null $mailru_id
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereMailruId($value)
...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email','unconfirmed_email', 'password','vkontakte_id','github_id','google_id','mailru_id'
    ];
